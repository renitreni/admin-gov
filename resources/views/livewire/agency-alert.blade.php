@if (!empty($agencyBanned))
    <x-filament-widgets::widget>
        @if ($agencyBanned)
            <div class="bg-red-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md" role="alert">
                <div class="flex">
                    <div class="py-1 mr-5">
                        <svg class="animate-ping absolute w-6 h-6 text-red-800" aria-hidden="true"
                    ...
                    <div>
                        <p class="font-bold">There is {{ $agencyBanned }} Banned Agencies</p>
                        <p class="text-sm">This message is showing a brief info for an Agency status.</p>
                    </div>
                </div>
            </div>
        @endif
